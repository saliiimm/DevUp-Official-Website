      ...
      <div id="departments-container">
        <div id="first-department">
          <HomeDepartmentsItem
            ...
            link="/department#det_Dev_Department"
          />
        </div>
        ...
        <HomeDepartmentsItem
          ...
          link="/department#det_Design_Department"
        ...
        <HomeDepartmentsItem
          ...
          description=" Craft intuitive and engaging UI/UX designs with Figma, Adobe Illustrator, and Photoshop. Join us to transform ideas into visual experiences."
          link="/department#det_Marketing_Department"
        />
        ...
        <HomeDepartmentsItem
          ...
          link="/department#det_Outreach_&_Opeartion_Department"
        />
        ...
        <HomeDepartmentsItem
          ...
          link="/department#det_Human_Resources_Department"
        />
      </div>
    </div>
  );
